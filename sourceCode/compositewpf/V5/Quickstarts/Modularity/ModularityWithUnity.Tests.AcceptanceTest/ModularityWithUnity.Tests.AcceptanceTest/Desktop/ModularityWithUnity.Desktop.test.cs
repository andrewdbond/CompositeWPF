...
using ModularityWithUnity.Tests.AcceptanceTest.TestEntities.Page;
...
namespace ModularityWithUnity.Tests.AcceptanceTest
{

#if DEBUG
    [DeploymentItem(@"TestData", "TestData")]
    [DeploymentItem(@"..\..\..\..\Desktop\ModularityWithUnity\ModularityWithUnity.Desktop\bin\Debug", "UNITY")]
#else
    [DeploymentItem(@"TestData", "TestData")]
    [DeploymentItem(@"..\..\..\..\Desktop\ModularityWithUnity\ModularityWithUnity.Desktop\bin\Release", "UNITY")]
#endif

    [TestClass]
    public class UnityDesktopTests : FixtureBase<WpfAppLauncher>
    {
        ...
        {
            Assert.IsNotNull(ModularityPage<WpfAppLauncher>.Window, "Modularity QuickStart - Desktop with Unity is not launched");
        }
        ...
        public void DesktopModulesLoadedOnStartup()
        {
            ...
            //Assert.IsTrue(aeClickToloadModuleC.Current.IsOffscreen, "Module C is not initialized at startup");
        ...
        {
            return ConfigHandler.GetValue("UnityAppLocation");
        }
