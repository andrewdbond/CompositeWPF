...
namespace Microsoft.Practices.Prism.Events
{
    ...
    public class CompositePresentationEvent<TPayload> : EventBase
    {
        ...
        /// <see cref="CompositePresentationEvent{TPayload}"/> will maintain a <see cref="WeakReference"/> to the target of the supplied <paramref name="action"/> delegate.
        /// </summary>
        ...
        /// CompositePresentationEvent will maintain a <see cref="WeakReference"/> to the Target of the supplied <paramref name="action"/> delegate.
        /// </summary>
