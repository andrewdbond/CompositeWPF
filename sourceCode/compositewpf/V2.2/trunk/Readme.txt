Composite Application Guidance v3 for WPF and Silverlight

This folder contains changes to the February 2009 release to target the Silverlight v3 platform.  

Note: Version 3 is work in progress and has not been fully tested.

============
Changes From V2
============
- Delegate and Composite commands hold weak references to CanExecuteChanged event handlers
- TabControlRegionAdapter sets the TabItem Header DataContext explicitly.
